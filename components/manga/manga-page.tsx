  ...
  return (
    <div className="mx-auto min-h-dvh w-full max-w-[1100px] px-4 pt-8 pb-12 sm:px-6 sm:pt-10">
      ...
      <button
        ...
        className="fixed right-4 bottom-[calc(4.5rem+env(safe-area-inset-bottom))] inline-flex items-center gap-2 rounded-full bg-brand px-5 py-3.5 font-medium text-white shadow-card transition-colors hover:bg-brand-strong sm:right-6 sm:bottom-6"
      >
