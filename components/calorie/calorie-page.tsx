  ...
  const handleSaveAnalysis = useCallback(
    (mealType: MealType) => {
      ...
      const entries: FoodEntry[] = rows.map((row) => ({
        ...
        originalCalories: row.match ? row.calories : null,
        originalProtein: row.match ? row.protein : null,
        originalCarbohydrates: row.match ? row.carbohydrates : null,
        originalFat: row.match ? row.fat : null,
